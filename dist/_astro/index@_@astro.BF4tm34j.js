...
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/node_modules/astro/components/Picture.astro", void 0);
...
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/node_modules/astro/components/Font.astro", void 0);
...
const logoVerde$1 = new Proxy({"src":"/_astro/logo-verde.rX9kckO8.webp","width":300,"height":156,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/logo-verde.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/logo-verde.webp");
							return target[name];
						}
					});
...
</p> </div> <!-- Decorative background elements --> <div class="absolute -top-24 -left-24 w-48 h-48 bg-[#4EAC9F]/5 rounded-full blur-3xl"></div> <div class="absolute -bottom-24 -right-24 w-48 h-48 bg-[#D1C1A3]/10 rounded-full blur-3xl"></div> </div> </div> ${renderScript($$result, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/components/ui/SearchModal.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/components/ui/SearchModal.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="dark"> <head><meta charset="UTF-8"><meta name="description" content="El amor es amor en cualquiera de sus formas Encontrar a esa persona ideal, que sea el cómplice perfecto para recorrer de principio a ..."><!-- Schema.org para Google+ --><meta itemprop="name" content="BODAS IGUALITARIAS EN MEDELLÍN"><meta itemprop="description" content="El amor es amor en cualquiera de sus formas Encontrar a esa persona ideal, que sea el cómplice perfecto para recorrer de principio a ..."><meta itemprop="image" content=" https://www.tusanagustin.com/assets/media/blog/bodas-igualitarias-en-medellin/272.jpg"><!-- Open Graph para Facebook--><meta property="og:title" content="BODAS IGUALITARIAS EN MEDELLÍN"><meta property="og:type" content="article"><meta property="og:url" content="https://www.tusanagustin.com/blog/bodas-igualitarias-en-medellin"><meta property="og:image" content="https://www.tusanagustin.com/assets/media/blog/bodas-igualitarias-en-medellin/272.jpg"><meta property="og:description" content="El amor es amor en cualquiera de sus formas Encontrar a esa persona ideal, que sea el cómplice perfecto para recorrer de principio a ..."><meta property="og:site_name" content="Tu San Agustin"><meta property="og:locale" content="es_LA"><meta name="keywords" content="Viajes y turismo san agustín"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="csrf-token" content="Sn6woLackUqYanWzaUZGKRRqVT9twqtK2XgC4UVm"><title>  BODAS IGUALITARIAS EN MEDELLÍN | Tu San Agustin</title>${renderHead()}</head> <body class="min-h-screen font-sans antialiased"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "ScrollToTop", $$ScrollToTop, {})} ${renderComponent($$result, "SearchModal", $$SearchModal, {})} </body></html>`;
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/layouts/Layout.astro", void 0);

const bannerImage = new Proxy({"src":"/_astro/003_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.Bs208nM9.webp","width":1749,"height":1396,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/003_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/003_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.webp");
							return target[name];
						}
					});

const $$Banner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="w-[calc(100%-8px)] md:w-[calc(100%-16px)] max-w-[2000px] h-[650px] md:h-[800px] relative rounded-[2rem] md:rounded-[3rem] overflow-hidden mx-auto" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": bannerImage, "class": "absolute inset-0 w-full h-full object-cover banner-zoom-animation", "style": "object-position: center;", "alt": "Amor Sin etiquetas", "loading": "eager", "fetchpriority": "high", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 75, "data-astro-cid-kggsjsm4": true })} <!-- Text Overlay --> <div class="absolute inset-0 flex flex-col justify-center items-start px-10 md:px-40 text-white z-20 pointer-events-none translate-y-40 md:translate-y-60" data-astro-cid-kggsjsm4> <div class="text-left" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-6xl lg:text-7xl font-poppins font-bold drop-shadow-2xl leading-tight tracking-tight" data-astro-cid-kggsjsm4>
Gay marriage in Colombia:
</h1> <p class="text-base md:text-xl lg:text-2xl font-poppins italic drop-shadow-2xl leading-tight mt-4 opacity-95 max-w-4xl tracking-widest" data-astro-cid-kggsjsm4>
A Sophisticated Guide to Your Luxury Same-Sex Wedding
...
const img11 = new Proxy({"src":"/_astro/MPYV8199.Bgw0o3JM.webp","width":4176,"height":2784,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/MPYV8199.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/MPYV8199.webp");
							return target[name];
						}
					});

const imgCartagena = new Proxy({"src":"/_astro/007_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.BoR7ouqR.webp","width":1749,"height":1396,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/007_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/007_boda_igualitaria_jardin_botanico_tu_san_agustin_lugares_para_eventos.webp");
							return target[name];
						}
					});

const imgPalms = new Proxy({"src":"/_astro/lawrson-pinson-v78Q07VnJBA-unsplash.C0UJHwkj.webp","width":2041,"height":2745,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/lawrson-pinson-v78Q07VnJBA-unsplash.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/lawrson-pinson-v78Q07VnJBA-unsplash.webp");
							return target[name];
						}
					});

const imgSanctuary = new Proxy({"src":"/_astro/0J8A4840.CFhMaFbV.webp","width":4480,"height":6720,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/0J8A4840.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/0J8A4840.webp");
							return target[name];
						}
					});

const $$GuideBody = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="bg-[#FDF5E9] w-full overflow-hidden text-[#333638] font-poppins" data-astro-cid-uh4uqfcj> <!-- HEADER INTRO (Image 0) --> <div class="text-center pt-24 pb-16 px-4" data-astro-cid-uh4uqfcj> <p class="max-w-3xl mx-auto text-sm md:text-base leading-relaxed text-[#333638] font-poppins" data-astro-cid-uh4uqfcj>
Celebre el amor sin fronteras. Descubra destinos de ensueño,<br class="hidden md:block" data-astro-cid-uh4uqfcj>
requisitos legales y cree bodas igualitarias de lujo en Colombia<br class="hidden md:block" data-astro-cid-uh4uqfcj>
con nuestra guía experta.
</p> </div> <div class="max-w-7xl mx-auto px-4 md:px-8 space-y-24 md:space-y-32" data-astro-cid-uh4uqfcj> <!-- SECTION 1: Amor en Plural (Image 0) --> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-3/5 space-y-6" data-astro-cid-uh4uqfcj> <div data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic leading-tight" data-astro-cid-uh4uqfcj>
Amor en Plural:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
Su Boda de Destino en el Corazón de Colombia
</h3> </div> <div class="space-y-6 text-sm md:text-base leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>
Imaginen un lugar donde la calidez no solo emana del sol caribeño, sino de la sonrisa abierta de su gente. Un país que ha transformado su narrativa en una de celebración, diversidad y brazos abiertos. Ese lugar es Colombia, un destino que, desde 2016, se consolidó como un faro progresista en Latinoamérica al aprobar el matrimonio igualitario.
</p> <p data-astro-cid-uh4uqfcj>
Para parejas de la comunidad LGBTQ+ que sueñan desde Panamá, México, Estados Unidos o cualquier rincón del mundo, Colombia trasciende la postal exótica para convertirse en un escenario legalmente sólido, donde su historia de amor se celebra con orgullo, sofisticación y una autenticidad conmovedora.
</p> <p data-astro-cid-uh4uqfcj>
Celebrar una boda igualitaria en Colombia es una declaración. Es elegir un país que vibra con la música, que deleita con sus sabores y que despliega una diversidad de paisajes asombrosa: desde el romance histórico de las murallas de Cartagena hasta la eterna primavera de Medellín.
</p> </div> </div> <div class="w-full md:w-2/5" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": imgKiss, "alt": "Boda igualitaria", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> </div> <!-- SECTION 2: Orquestar una boda (Image 0 bottom) - IMAGE LEFT --> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-2/5 order-2 md:order-1" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": img11, "alt": "Orquestar boda de destino", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> <div class="w-full md:w-3/5 space-y-6 order-1 md:order-2" data-astro-cid-uh4uqfcj> <p class="text-sm md:text-base leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj>
Pero orquestar una boda de destino —y más aún, una que garantice un entorno de absoluta inclusión y lujo— requiere más que logística. Exige una curaduría experta, una sensibilidad innata y un profundo conocimiento del terreno. En Tu San Agustín, no solo planeamos eventos; orquestamos atmósferas en las que el amor, en todas sus magníficas formas, es el único protagonista. Considere este artículo su guía personal, un mapa que los llevará por los aspectos legales, los destinos más icónicos y el secreto para que su celebración sea tan única como su unión.
</p> </div> </div> <!-- SECTION 3: ¿Por qué Colombia? (Image 1) --> <div class="space-y-12" data-astro-cid-uh4uqfcj> <div class="max-w-4xl" data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic leading-tight" data-astro-cid-uh4uqfcj>
¿Por qué Colombia es el Destino Ideal
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic mb-6" data-astro-cid-uh4uqfcj>
para Bodas LGBTQ+ de Lujo?
</h3> <p class="text-sm md:text-base leading-relaxed" data-astro-cid-uh4uqfcj>
La elección de un destino para el día más importante de su vida trasciende la belleza visual. Para las parejas LGBTQ+, la seguridad, la aceptación legal y una infraestructura de lujo inclusiva no son negociables. Colombia no solo cumple, sino que supera estas expectativas.
</p> </div> <!-- La Solidez Legal --> <div class="flex flex-col md:flex-row gap-12" data-astro-cid-uh4uqfcj> <div class="w-full md:w-1/2 space-y-6 mt-12" data-astro-cid-uh4uqfcj> <h2 class="text-3xl md:text-4xl font-poppins font-bold text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>
La Solidez Legal:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic leading-tight" data-astro-cid-uh4uqfcj>
Matrimonio Igualitario en Colombia
</h3> <p class="text-sm md:text-base leading-relaxed" data-astro-cid-uh4uqfcj>
El hito ocurrió en 2016. Mediante la Sentencia SU-214, la Corte Constitucional de Colombia legalizó el matrimonio entre personas del mismo sexo, otorgando exactamente los mismos derechos y deberes que a las parejas heterosexuales. La trascendencia de este marco legal es innegable:
</p> </div> </div> <!-- 3 Rounded Boxes (Image 1) --> <div class="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8" data-astro-cid-uh4uqfcj> <div class="bg-[#D1C1A3] bg-opacity-40 p-10 rounded-[2.5rem] flex flex-col items-center text-center space-y-4" data-astro-cid-uh4uqfcj> <h4 class="text-xl font-bold font-poppins italic text-white md:text-[#333638] bg-[#D1C1A3] md:bg-transparent px-4 py-1 rounded-full" data-astro-cid-uh4uqfcj>Validez Internacional:</h4> <p class="text-sm leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj>
Un matrimonio civil celebrado en Colombia es reconocido legalmente en la mayoría de países (como EE. UU, México, España y muchos otros en LATAM y Europa) que también reconocen el matrimonio igualitario.
</p> </div> <div class="bg-[#D1C1A3] bg-opacity-40 p-10 rounded-[2.5rem] flex flex-col items-center text-center space-y-4 md:mt-24" data-astro-cid-uh4uqfcj> <h4 class="text-xl font-bold font-poppins italic text-white md:text-[#333638] bg-[#D1C1A3] md:bg-transparent px-4 py-1 rounded-full" data-astro-cid-uh4uqfcj>Sin Barreras para Extranjeros:</h4> <p class="text-sm leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj>
Colombia no exige residencia para que dos personas extranjeras contraigan matrimonio legal en el país. El proceso es claro y accesible, permitiendo a parejas internacionales formalizar su unión con facilidad.
</p> </div> <div class="bg-[#D1C1A3] bg-opacity-40 p-10 rounded-[2.5rem] flex flex-col items-center text-center space-y-4 md:mt-52" data-astro-cid-uh4uqfcj> <h4 class="text-xl font-bold font-poppins italic text-white md:text-[#333638] bg-[#D1C1A3] md:bg-transparent px-4 py-1 rounded-full" data-astro-cid-uh4uqfcj>Protección y Derechos:</h4> <p class="text-sm leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj>
Más allá de la ceremonia, esto garantiza un marco legal que protege su unión en términos de patrimonio, nacionalidad (si aplica) y todos los derechos conyugales.
</p> </div> </div> </div> <!-- SECTION 4: Una Cultura de Celebración (Image 2) --> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-3/5 space-y-6" data-astro-cid-uh4uqfcj> <div data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic leading-tight" data-astro-cid-uh4uqfcj>
Una Cultura de Celebración
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
y Calidez Humana
</h3> </div> <div class="space-y-6 text-sm md:text-base leading-relaxed" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>
Colombia es, por naturaleza, un país festivo. La "alegría" es parte de nuestro ADN. Esta cultura se ha traducido en una industria de bodas vibrante y cada vez más consciente. En ciudades cosmopolitas como Bogotá, Medellín y Cartagena, la diversidad no solo se acepta, se celebra con entusiasmo.
</p> <p data-astro-cid-uh4uqfcj>
Aquí encontrarán una nueva generación de proveedores de lujo —fotógrafos, chefs, floristas y diseñadores— que entienden y celebran activamente las bodas LGBTQ+. El miedo a tener que preguntar "¿Eres friendly?" desaparece cuando trabajan con un equipo que ya ha sido curado bajo una filosofía de inclusión total.
</p> </div> </div> <div class="w-full md:w-2/5" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": imgKiss, "alt": "Cultura de celebraci\xF3n", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> </div> <!-- SECTION 5: Lujo sin Concesiones (Image 2 bottom) --> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16 justify-end" data-astro-cid-uh4uqfcj> <div class="w-full md:w-3/5 space-y-6" data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic leading-tight" data-astro-cid-uh4uqfcj>
Lujo sin Concesiones:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
El Valor de una Experiencia Premium
</h3> <p class="text-sm md:text-base leading-relaxed" data-astro-cid-uh4uqfcj>
Colombia ofrece una tasa de cambio extremadamente favorable para quienes provienen de países con moneda fuerte como el dólar o el euro. Esto permite que un presupuesto destinado a una boda de lujo se magnifique, brindando acceso a experiencias que en otros destinos serían prohibitivas. Aquí, el lujo no es solo asequible, es abundante.
</p> </div> </div> <div class="border-t-8 border-[#333638] w-full pt-16" data-astro-cid-uh4uqfcj></div> <!-- SECTION 6: Destinos de Ensueño (Image 3) --> <div class="space-y-12" data-astro-cid-uh4uqfcj> <div data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic mb-1" data-astro-cid-uh4uqfcj>
Destinos de Ensueño
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
para su Celebración
</h3> <p class="text-sm md:text-base leading-relaxed mt-6 max-w-3xl" data-astro-cid-uh4uqfcj>
Colombia no es un solo destino; son mundos enteros esperando ser descubiertos. La locación definirá el alma y el tono de su boda.
</p> </div> <!-- Cartagena --> <div class="text-center space-y-4" data-astro-cid-uh4uqfcj> <h2 class="text-3xl md:text-4xl font-poppins font-bold text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>
Cartagena y Barú:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
Romance Histórico y Lujo Caribeño
</h3> </div> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-3/5 space-y-8 text-sm md:text-base" data-astro-cid-uh4uqfcj> <ul class="space-y-6" data-astro-cid-uh4uqfcj> <li class="flex items-start gap-3" data-astro-cid-uh4uqfcj> <span class="text-[#4EAC9F] text-2xl" data-astro-cid-uh4uqfcj>•</span> <span data-astro-cid-uh4uqfcj><strong class="text-[#4EAC9F]" data-astro-cid-uh4uqfcj>El Tono:</strong> Sofisticado, histórico, tropical y magnético.</span> </li> <li class="flex items-start gap-3" data-astro-cid-uh4uqfcj> <span class="text-[#4EAC9F] text-2xl" data-astro-cid-uh4uqfcj>•</span> <span data-astro-cid-uh4uqfcj><strong class="text-[#4EAC9F]" data-astro-cid-uh4uqfcj>Por qué es ideal:</strong> Es una ciudad cosmopolita acostumbrada a la diversidad, con la infraestructura de lujo más desarrollada del país.</span> </li> <li class="flex items-start gap-3" data-astro-cid-uh4uqfcj> <span class="text-[#4EAC9F] text-2xl" data-astro-cid-uh4uqfcj>•</span> <span data-astro-cid-uh4uqfcj><strong class="text-[#4EAC9F]" data-astro-cid-uh4uqfcj>Locaciones Perfectas:</strong></span> </li> <li class="pl-10 space-y-4" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj><strong class="text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>Casas Coloniales:</strong> Patios mágicos, balcones rebosantes de buganvillas y piscinas privadas para ceremonias íntimas y recepciones de alta gama.</p> <p data-astro-cid-uh4uqfcj><strong class="text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>Baluartes:</strong> Imaginen una cena inolvidable bajo un manto de estrellas, sobre las históricas murallas, con la brisa del Caribe como banda sonora.</p> <p data-astro-cid-uh4uqfcj><strong class="text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>Islas Privadas (Barú y Rosario):</strong> Para una experiencia "wow" definitiva. Ceremonias en playas de arena blanca y fiestas exclusivas que se extienden durante todo un fin de semana. <a href="/bodas-destino-cartagena" class="text-[#4EAC9F] underline" data-astro-cid-uh4uqfcj>[Enlazar a: /bodas-destino-cartagena]</a></p> </li> </ul> </div> <div class="w-full md:w-2/5" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": imgCartagena, "alt": "Romance en Cartagena", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> </div> </div> <!-- Medellín, Bogotá y Cali (Image 3 bottom / Image 4) --> <div class="space-y-8 py-12" data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic text-center md:text-left" data-astro-cid-uh4uqfcj>
Medellín, Bogotá y Cali:
</h2> <div class="space-y-6 text-sm md:text-base leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>
Las principales ciudades de Colombia ofrecen una escena LGBTQ+ vibrante y visible. Medellín, con su eterna primavera y rooftops de diseño; Bogotá, con su sofisticación capitalina y clubes de clase mundial; y Cali, donde la alegría de la salsa se vive sin etiquetas. Estas metrópolis ofrecen hoteles de lujo gay-celebrated y una infraestructura perfecta para bodas modernas y chic.
</p> <div class="text-center italic text-[#333638] pt-8 space-y-4" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>¿Buscan un rooftop en Medellín o una hacienda histórica en el Valle del Cauca?</p> <p data-astro-cid-uh4uqfcj>Exploren nuestra <a href="#" class="text-[#4EAC9F] underline" data-astro-cid-uh4uqfcj>Galería de Lugares para Matrimonios en Colombia.</a></p> </div> </div> </div> <!-- Eje Cafetero (Image 4 middle) --> <div class="space-y-12" data-astro-cid-uh4uqfcj> <div class="text-center space-y-2" data-astro-cid-uh4uqfcj> <h2 class="text-3xl md:text-4xl font-poppins font-bold text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>
Eje Cafetero y Villa de Leyva:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
Experiencias Boutique y Auténticas
</h3> <p class="pt-4" data-astro-cid-uh4uqfcj>Para parejas que buscan una conexión más profunda con la tierra, en un ambiente de "lujo silencioso".</p> </div> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-3/5 space-y-8 text-sm md:text-base" data-astro-cid-uh4uqfcj> <ul class="space-y-8" data-astro-cid-uh4uqfcj> <li class="flex items-start gap-3" data-astro-cid-uh4uqfcj> <span class="text-[#4EAC9F] text-2xl" data-astro-cid-uh4uqfcj>•</span> <span data-astro-cid-uh4uqfcj><strong class="text-[#4EAC9F]" data-astro-cid-uh4uqfcj>Eje Cafetero:</strong> Celebraciones en haciendas cafeteras tradicionales reconvertidas en hoteles boutique de lujo. Las ceremonias aquí tienen como telón de fondo los imponentes valles de palmas de cera. Es una inmersión total en la cultura y la belleza natural.</span> </li> <li class="flex items-start gap-3" data-astro-cid-uh4uqfcj> <span class="text-[#4EAC9F] text-2xl" data-astro-cid-uh4uqfcj>•</span> <span data-astro-cid-uh4uqfcj><strong class="text-[#4EAC9F]" data-astro-cid-uh4uqfcj>Villa de Leyva:</strong> Un pueblo colonial perfectamente conservado, con una plaza monumental y un aire bohemio-chic. Perfecto para bodas de estética rústica-elegante, llenas de encanto y autenticidad.</span> </li> </ul> </div> <div class="w-full md:w-2/5" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": imgPalms, "alt": "Palmas de Cera Eje Cafetero", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> </div> <div class="text-center italic text-[#333638] py-8 space-y-2" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>¿Cartagena, Medellín o el Eje Cafetero?</p> <p data-astro-cid-uh4uqfcj>Cada destino tiene una magia distinta. Ayudémosles a encontrar el escenario que mejor narre su historia de amor. <a href="#" class="text-[#4EAC9F] underline" data-astro-cid-uh4uqfcj>Ver galería de destinos exclusivos</a></p> </div> </div> <!-- SECTION 7: Tu San Agustín Sanctury (Image 4 bottom) --> <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16" data-astro-cid-uh4uqfcj> <div class="w-full md:w-2/5 order-2 md:order-1" data-astro-cid-uh4uqfcj> <div class="rounded-t-full overflow-hidden shadow-2xl aspect-[3/4] max-w-sm mx-auto" data-astro-cid-uh4uqfcj> ${renderComponent($$result, "Image", $$Image, { "src": imgSanctuary, "alt": "Tu San Agust\xEDn Santuario", "class": "w-full h-full object-cover", "data-astro-cid-uh4uqfcj": true })} </div> </div> <div class="w-full md:w-3/5 space-y-6 order-1 md:order-2" data-astro-cid-uh4uqfcj> <div data-astro-cid-uh4uqfcj> <h2 class="text-4xl md:text-5xl font-poppins font-bold text-[#D1C1A3] italic leading-tight" data-astro-cid-uh4uqfcj>
Tu San Agustín:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
Creamos Santuarios para Celebrar el Amor
</h3> </div> <div class="space-y-6 text-sm md:text-base leading-relaxed text-[#333638]" data-astro-cid-uh4uqfcj> <p data-astro-cid-uh4uqfcj>
Entendemos la diferencia fundamental entre ser "gay-friendly" y ser "gay-celebrated". Esta distinción es el pilar de nuestro servicio y la base sobre la que construimos cada experiencia.
</p> <p data-astro-cid-uh4uqfcj>
Nuestra promesa es garantizar un entorno de absoluta confianza y celebración. Para ello, hemos creado una red exclusiva de los proveedores más talentosos de Colombia, seleccionados rigurosamente no solo por su excelencia artística y profesional, sino por su demostrado y genuino compromiso como aliados de la comunidad LGBTQ+.
</p> </div> </div> </div> <!-- FINAL PROMISE --> <div class="text-center space-y-2 pt-16 pb-32" data-astro-cid-uh4uqfcj> <h2 class="text-3xl md:text-4xl font-poppins font-bold text-[#D1C1A3] italic" data-astro-cid-uh4uqfcj>
Nuestra Promesa:
</h2> <h3 class="text-2xl md:text-3xl font-poppins font-bold text-[#4EAC9F] italic" data-astro-cid-uh4uqfcj>
Inclusión Real y Lujo sin Fricciones
</h3> </div> <div class="border-t-2 border-[#333638] opacity-20 w-full" data-astro-cid-uh4uqfcj></div> </div> </div> `;
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/components/GuideBody.astro", void 0);
...
const flagColombia = new Proxy({"src":"/_astro/colombia.gIt7YGB2.webp","width":32,"height":32,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/colombia.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/colombia.webp");
							return target[name];
						}
					});
...
const iconFb = new Proxy({"src":"/_astro/Facebook.BK6UR8KJ.webp","width":16,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Facebook.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Facebook.webp");
							return target[name];
						}
					});
...
const iconIg = new Proxy({"src":"/_astro/Instagram.kjCPTWja.webp","width":28,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Instagram.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Instagram.webp");
							return target[name];
						}
					});
...
const iconTk = new Proxy({"src":"/_astro/TikTock.B63molJW.webp","width":25,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/TikTock.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/TikTock.webp");
							return target[name];
						}
					});
...
const iconLi = new Proxy({"src":"/_astro/Link.DdrVHlIV.webp","width":30,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Link.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Link.webp");
							return target[name];
						}
					});
...
const iconYt = new Proxy({"src":"/_astro/Youtube.D-jMaSlS.webp","width":40,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Youtube.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Youtube.webp");
							return target[name];
						}
					});
...
const iconWa = new Proxy({"src":"/_astro/Whatsapp.BjEMeso6.webp","width":28,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Whatsapp.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Whatsapp.webp");
							return target[name];
						}
					});
...
const imgPorcentaje = new Proxy({"src":"/_astro/porcentaje.BydswUy6.webp","width":174,"height":171,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/porcentaje.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/porcentaje.webp");
							return target[name];
						}
					});
...
const imgFontur = new Proxy({"src":"/_astro/cert-fontur.BgZSmE2p.webp","width":203,"height":203,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/cert-fontur.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/cert-fontur.webp");
							return target[name];
						}
					});
...
const imgCamara = new Proxy({"src":"/_astro/logo-camara-comercio-medellin.XRPUbkZx.webp","width":2983,"height":1220,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/logo-camara-comercio-medellin.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/logo-camara-comercio-medellin.webp");
							return target[name];
						}
					});
...
const imgTrayectoria = new Proxy({"src":"/_astro/cert-trayectoria.QMCjwiAI.webp","width":281,"height":195,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/cert-trayectoria.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/cert-trayectoria.webp");
							return target[name];
						}
					});
...
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/components/BrandInfo.astro", void 0);
...
const imgVisa = new Proxy({"src":"/_astro/visa.int71ITQ.webp","width":138,"height":56,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/visa.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/visa.webp");
							return target[name];
						}
					});
...
const imgMastercard = new Proxy({"src":"/_astro/mastercard.CtyX3pUV.webp","width":95,"height":56,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/mastercard.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/mastercard.webp");
							return target[name];
						}
					});
...
const imgPaypal = new Proxy({"src":"/_astro/paypal.CsAQGOL6.webp","width":197,"height":59,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/paypal.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/paypal.webp");
							return target[name];
						}
					});
...
const imgPse = new Proxy({"src":"/_astro/pse.BUFSsZyF.webp","width":155,"height":66,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/pse.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/pse.webp");
							return target[name];
						}
					});
...
const imgWompi = new Proxy({"src":"/_astro/wompi.CvLSIJPN.webp","width":140,"height":49,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/wompi.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/wompi.webp");
							return target[name];
						}
					});
...
const iconPi = new Proxy({"src":"/_astro/Pinterest _1.80luK4it.webp","width":22,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Pinterest _1.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/Pinterest _1.webp");
							return target[name];
						}
					});
...
const award1 = new Proxy({"src":"/_astro/home_tusanagustin-29.DOPuVTPQ.webp","width":1282,"height":1282,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-29.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-29.webp");
							return target[name];
						}
					});
...
const award2 = new Proxy({"src":"/_astro/home_tusanagustin-30.Dhs0SYXa.webp","width":1114,"height":847,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-30.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-30.webp");
							return target[name];
						}
					});
...
const award3 = new Proxy({"src":"/_astro/home_tusanagustin-31.Cs9-dPnH.webp","width":1102,"height":999,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-31.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-31.webp");
							return target[name];
						}
					});
...
const award4 = new Proxy({"src":"/_astro/home_tusanagustin-32.CxsgrUDw.webp","width":1172,"height":1173,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-32.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-32.webp");
							return target[name];
						}
					});
...
const award5 = new Proxy({"src":"/_astro/home_tusanagustin-34-1.C2_XsAta.webp","width":1312,"height":1312,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-34-1.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-34-1.webp");
							return target[name];
						}
					});
...
const award6 = new Proxy({"src":"/_astro/home_tusanagustin-35.DFsvjQRI.webp","width":1102,"height":1072,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-35.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-35.webp");
							return target[name];
						}
					});
...
const award7 = new Proxy({"src":"/_astro/home_tusanagustin-36.VJVSOJ4y.webp","width":1133,"height":1137,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-36.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-36.webp");
							return target[name];
						}
					});
...
const award8 = new Proxy({"src":"/_astro/home_tusanagustin-37.Dli4IywY.webp","width":1102,"height":919,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-37.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-37.webp");
							return target[name];
						}
					});
...
const award9 = new Proxy({"src":"/_astro/home_tusanagustin-38.BzgRnXvU.webp","width":1102,"height":1327,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-38.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-38.webp");
							return target[name];
						}
					});
...
const award10 = new Proxy({"src":"/_astro/home_tusanagustin-41.DzLcKwvj.webp","width":1172,"height":1172,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-41.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/home_tusanagustin-41.webp");
							return target[name];
						}
					});
...
const award11 = new Proxy({"src":"/_astro/diseño-sin-título-10.DeXZggfe.webp","width":1080,"height":1350,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/diseño-sin-título-10.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/diseño-sin-título-10.webp");
							return target[name];
						}
					});
...
const award12 = new Proxy({"src":"/_astro/diseño-sin-título-2.Do--M1qd.webp","width":1080,"height":1350,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/diseño-sin-título-2.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/assets/images/diseño-sin-título-2.webp");
							return target[name];
						}
					});
...
}, "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/pages/index.astro", void 0);

const $$file = "C:/Users/KEVIN/Desktop/Paginasde aterrizaje bodas destino/boda igualitaria/src/pages/index.astro";
const $$url = "";
